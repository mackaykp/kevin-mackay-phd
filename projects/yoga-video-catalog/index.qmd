...
#| echo: false
#| results: asis
cat("```python\n", paste(readLines("scripts/update_from_channels.py"), collapse = "\n"), "\n```\n", sep = "")
```
...
#| echo: false
#| results: asis
cat("```python\n", paste(readLines("scripts/scrape_channel.py"), collapse = "\n"), "\n```\n", sep = "")
```
...
#| echo: false
#| results: asis
cat("```python\n", paste(readLines("scripts/enrich_videos.py"), collapse = "\n"), "\n```\n", sep = "")
```
...
#| echo: false
#| results: asis
cat("```python\n", paste(readLines("scripts/categorize_data.py"), collapse = "\n"), "\n```\n", sep = "")
```
...
#| echo: false
#| results: asis
cat("```python\n", paste(readLines("scripts/update_focus.py"), collapse = "\n"), "\n```\n", sep = "")
```
:::
